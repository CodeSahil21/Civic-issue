  ...
  if (error) {
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
        <p className="text-red-800">Error loading activity: {error}</p>
      </div>
    );
  }
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Track all your issue activities and updates</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-800">
            Activity History ({pagination.total})
          </h3>
        </div>
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="font-medium text-gray-900">#{issue.ticketNumber}</span>
                  ...
                  <div className="flex items-center gap-4 text-xs text-gray-500">
                    ...
                    {issue.ward && (
                      <span>Ward {issue.ward.wardNumber} - {issue.ward.name}</span>
                    )}
                  </div>
                </div>
        ...
        {issues.length === 0 && (
          <div className="px-6 py-12 text-center">
            ...
            <p className="text-sm text-gray-400 mt-2">Your issue activities will appear here</p>
          </div>
        )}
      </div>
